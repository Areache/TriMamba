...
def main(config: DictConfig):
    ...
    import wandb
    # print("WandB experiment:", self.experiment)
    print("WANDB_MODE env:", os.getenv("WANDB_MODE"))
    print("WandB run:", wandb.run)
    print("Offline mode:", getattr(wandb.run._settings, "_offline", False) if wandb.run else "no run")
