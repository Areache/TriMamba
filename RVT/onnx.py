...
# checkpoint=/capstor/scratch/cscs/cyujie/ssms_event_cameras/hs7571p6/checkpoints/onnx_test.ckpt use_test_set=1 hardware.gpus=0 +experiment/gen4="small.yaml" \
...
def main(config: DictConfig):
    ...
    # dummy_input = torch.randn(10, 12, 20, 384, 640, requires_grad=True).to(device) 
    dummy_input = torch.randn(12, 20, 360, 640, requires_grad=True).to(device) 
