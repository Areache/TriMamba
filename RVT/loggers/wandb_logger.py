...
class WandbLogger(Logger):
    ...
    def _get_public_run(self):
        ...
        if self.experiment is None or self.experiment.mode == "offline" or os.getenv("WANDB_MODE") == "offline":
            return None
    ...
    def _scan_and_log_checkpoints(
        ...
        if self.experiment is None or getattr(self.experiment, "mode", None) == "offline" or os.getenv("WANDB_MODE") == "offline":
            return
